...
CREATE TABLE `classificacao` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idclassificacao_UNIQUE` (`id`),
  UNIQUE KEY `classificacao_UNIQUE` (`nomeclassificacao`)
...
INSERT INTO `classificacao` VALUES ('3eae18e1-1250-11ef-81c3-a8a159e1c854','132','2024-05-14 00:00:00',NULL),('3eaf95bb-1250-11ef-81c3-a8a159e1c854','1162','2024-05-14 00:00:00',NULL);
