...
CREATE TABLE `tipomidia` (
  ...
  `nometipomidia` varchar(50) NOT NULL,
  `datadecadastro` datetime NOT NULL,
  `datainativo` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  UNIQUE KEY `nometipomidia_UNIQUE` (`nometipomidia`)
...
INSERT INTO `tipomidia` VALUES ('3eae171b-1250-11ef-81c3-a8a159e1c854','teste','2024-05-14 00:00:00',NULL),('3eaf94bc-1250-11ef-81c3-a8a159e1c854','te4646ste','2024-05-14 00:00:00',NULL);
